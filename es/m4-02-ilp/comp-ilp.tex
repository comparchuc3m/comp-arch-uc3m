...
\begin{itemize}
  \item ILP directamente aplicables a bloques básicos.
    \begin{itemize}
      ...
      \item Programa \textmark{típico} en MIPS:
        \begin{itemize}
...
\begin{columns}
  ...
  \begin{column}{.4\textwidth}
    \begin{block}{Ejemplo}
      \lstinputlisting{es/m4-02-ilp/comp-ilp-ex1.cpp}
    \end{block}
  \end{column}
...
\begin{column}{.4\textwidth}
\begin{block}{Ejemplo}
\lstinputlisting{es/m4-02-ilp/comp-ilp-ex2.cpp}
\end{block}
\end{column}
...
\begin{itemize}
  \item \textgood{R1} $\rightarrow$ Último elemento de array.
  \item \textgood{F2} $\rightarrow$ Escalar \cppid{s}.
  \item \textgood{R2} $\rightarrow$ Precalculado para que \asmlabel{8(R2)} sea primer elemento de array.
\end{itemize}

\mode<presentation>{\vfill}
\begin{block}{Código ensamblador}
\lstinputlisting[language=generalasm]{es/m4-02-ilp/comp-ilp-ex3.asm}
\end{block}
...
\lstinputlisting[language=generalasm2]{es/m4-02-ilp/comp-ilp-ex4.asm}
\end{block}
\end{column}
...
\lstinputlisting[language=generalasm2]{es/m4-02-ilp/comp-ilp-ex4b.asm}
\end{block}
\end{column}
...
\lstinputlisting[language=generalasm2]{es/m4-02-ilp/comp-ilp-ex4c.asm}
\end{block}
\begin{itemize}
...
\lstinputlisting[language=generalasm2,lastline=7]{es/m4-02-ilp/loop-unroll0.asm}
\end{block}
\end{column}

\begin{column}{.45\textwidth}
\begin{block}{Desenrollado (x4)}
\lstinputlisting[language=generalasm2,firstline=8]{es/m4-02-ilp/loop-unroll0.asm}
\end{block}
\end{column}
...
\begin{column}{.45\textwidth}
\begin{block}{Desenrollado (x4)}
\lstinputlisting[language=generalasm2,firstline=1,lastline=14]{es/m4-02-ilp/loop-unroll1.asm}
\end{block}
\end{column}

\begin{column}{.45\textwidth}
\begin{block}{Desenrollado (x4)}
\lstinputlisting[language=generalasm2,firstline=15]{es/m4-02-ilp/loop-unroll1.asm}
\end{block}
\end{column}
...
\begin{column}{.45\textwidth}
\begin{block}{Desenrollado (x4)}
\lstinputlisting[language=generalasm2]{es/m4-02-ilp/loop-unroll2.asm}
\end{block}
\end{column}
...
\begin{itemize}
  \item Reorganización de código.
    ...
    \end{itemize}
  \item Actualización de \asmreg{R1} suficientemente separada de
        \asminst{BNE}.

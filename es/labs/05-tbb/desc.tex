...
En este ejercicio veremos las distintas formas de repartir el trabajo entre los
...
Para ejecutar trabajos en el clúster \textmark{avignon}, deberás crear un
\emph{script} para lanzar la compilación.
\end{tcolorbox}

Por ejemplo, el script del listado~\ref{lst:build-normal} permite compilar en un
nodo normal del cluster \textmark{avignon}. En primer lugar, se genera la
configuración de compilación en el directorio \textemph{build/normal}. A
continuación se realiza la compilación generando los ejecutables
correspondientes utilizando la configuración de compilación
\textemph{gcc-release} y la configuración \textemph{Release}.

\lstinputlisting[
caption={Script de compilación para nodo normal del clúster \textmark{avignon}},

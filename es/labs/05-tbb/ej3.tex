...
En este ejercicio vamos a ver como se puede optimizar un algoritmo de reducción.
Loa vamos a aplicar a un algoritmo que calcula el área de un círculo como paso
...
Por tanto el valor de $\pi$ se puede aproximar:
...
auto resultado = tbb::parallel_reduce(
    ...
    [=](tbb::blocked_range<std::size_t> const & r, double init) {
      for (auto i=r.begin(); i!=r.end(); ++i) {
        // Realizar cálculos y a actualizar init
      }
      return init;
    },

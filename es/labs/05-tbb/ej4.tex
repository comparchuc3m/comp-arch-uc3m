...
aleatorias dentro de un cuadrado de lado \cppid{1.0}. La proporción del puntos
cuya distancia a la esquina inferior izquierda es menor o igual que \cppid{1.0}
coincide con el valor $\frac{\pi}{4}$. El valor será más preciso cuanto mayor
...
como el que se presenta en el listado~\ref{lst:pi-par-montecarlo}.

...
En Aula Global encontrarás un archivo \cppid{mandel.zip} con todo el código que
...
\paragraph{Compilación de la versión de depuración}
...
\paragraph{Compilación de la versión optimizada}
...
\begin{itemize}
  \item Genera una configuración de proyecto en el directorio \cppid{mandel-release}
        ...
        que hace que se utilicen las opciones de compilación con optimizaciones.
\begin{lstlisting}[style=terminal]
cmake -S mandel -B mandel-release -DCMAKE_BUILD_TYPE=Release
\end{lstlisting}
\end{itemize}

\paragraph{Construcción del proyecto}

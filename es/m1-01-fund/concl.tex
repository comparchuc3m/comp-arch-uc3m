...
\begin{itemize}
  ...
  \item Nuevos modelos mejoran rendimiento (\textmark{DLP}, \textmark{TLP}, \textmark{RLP}), 
  ...
  \mode<presentation>{\pause\vfill}
  \item Nuevas arquitecturas que combinan \textmark{SIMD} y \textmark{MIMD}.

  \mode<presentation>{\pause\vfill}
  \item Diferencia entre \textmark{ISA} y \emph{arquitectura}.
\end{itemize}
\end{frame}

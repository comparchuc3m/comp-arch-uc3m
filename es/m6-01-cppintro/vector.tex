...
\begin{frame}[t,fragile]{Vectores e inicialización}
\begin{itemize}
  \item Un vector con tamaño inicializa todos sus valores al valor por defecto del tipo.
    \begin{itemize}
...
\begin{lstlisting}
std::vector<double> v; // Vector con 0 elementos
\end{lstlisting}

  \vfill
  \item Se puede suministrar un valor inicial distinto.
\begin{lstlisting}
std::vector<double> v(100, 0.5); // 100 posiciones inicializadas a 0.5
\end{lstlisting}
\end{itemize}
\end{frame}

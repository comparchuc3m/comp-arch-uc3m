...
\mode<article>{
\begin{itemize}
  \item \alert{Observación}: Aunque reducir una instrucción (FPSQR) de 20 ciclos a 2 ciclos
        puede resultar llamativo, se consigue una mejora similar con una reducción mucho más
        modesta (de 4 a 2 ciclos) para una familia de instrucciones.
\end{itemize}
}
\end{frame}

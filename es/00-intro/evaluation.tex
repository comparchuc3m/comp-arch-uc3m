...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textgood{Evaluación continua}: 60\% de la calificación final.
      \begin{itemize}
        \item \textmark{Exámenes parciales}: 20\% de la calificación final.
        \item \textmark{Proyecto}: 40\% de la calificación final.
      \end{itemize}
  \end{itemize}
...
\begin{itemize}
  \item Si sigues el proceso de \textmark{evaluación continua}:
    ...
    \item \textgood{Examen final}: 40\%.
      ...
      \end{itemize}
    \item \textgood{Exámenes parciales}: 20\%
      \begin{itemize}
        \item Mínimo necesario: \alert{No hay mínimo}.
      \end{itemize}
    \item \textgood{Proyecto}: 40\%.
      \begin{itemize}
...
\begin{itemize}
  \item \textmark{SEIS sesiones de laboratorio}:
    \begin{itemize}
      ...
      \item \textbad{IMPORTANTE}: Preguntas de laboratorio sobre trabajo realizado.
    \end{itemize}

  \mode<presentation>{\vfill}
  \item \textemph{Sesiones de laboratorio}:
    \begin{itemize}
      \item Semana 2 (15/09 -- 29/09): \textgood{C++ básico}.
      \item Semana 3 (22/09 -- 26/09): \textgood{Rendimiento y energía}.
      \item Semana 5 (06/10 -- 10/10): \textgood{Memoria caché}.
      \item Semana 8 (27/10 -- 31/10): \textgood{Programación paralela}.
      \item Semana 10 (10/11 -- 14/11): \textgood{Programación paralela}.
      \item Semana 13 (1/12 -- 05/12): \textgood{Consistencia de memoria}.
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item \textgood{Evaluación}:
    \begin{itemize}
      ...
      \item Trabajo continuo en repositorio privado en \textemph{github}.
      \item \textgood{Peso}: 40\% de la nota final.

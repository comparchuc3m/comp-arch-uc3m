...
\begin{itemize}
  ...
  \item \textemph{Sesiones de laboratorio}:
    \begin{itemize}
      \item Semana 2 (11/09 -- 15/09): \textgood{C++ básico}.
      \item Semana 3 (18/09 -- 22/09): \textgood{Rendimiento y energía}.
      \item Semana 5 (02/10 -- 06/10): \textgood{Memoria caché}.
      \item Semana 8 (23/10 -- 27/10): \textgood{Introducción a OpenMP}.
      \item Semana 10 (06/11 -- 10/11): \textgood{OpenMP}.
      \item Semana 13 (17/11 -- 01/12): \textgood{Consistencia de memoria}.
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
  \item Un proyecto de programación orientada al rendimiento.
    \begin{itemize}
...
\begin{frame}[t]{Reglas y resolució de conflictos}
\begin{itemize}
  \item \textemph{Reglas}:
    \begin{itemize}

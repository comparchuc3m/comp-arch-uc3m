...
\begin{itemize}
  \item \asmlabel{I2} lee \asmreg{R1} antes que \asmlabel{I1} la modifique.
  \item \asmlabel{I3} lee \asmreg{R1} antes de que \asmlabel{I1} la modifique.
...
\begin{itemize}
  \item Si hay dependencia de datos, las instrucciones:
    \begin{itemize}
      ...
      \item La instrucción \cppkey{sub} necesita el valor de \cppid{\$1}
...
\begin{itemize}
  \item Conocido como \textmark{antidependencia} en compiladores.
    \begin{itemize}
      ...
      \item La instrucción \cppkey{add} modifica \cppid{\$1}
...
\mode<presentation>{\pause\vfill}
\begin{itemize}
  \item \alert{No puede} ocurrir en un MIPS con \textmark{pipeline de 5 etapas}.
  \begin{itemize}
...
\makebox[\textwidth][c]{
\input{es/m4-01-ilp/forward.tkz}
}
\end{frame}
...
\makebox[\textwidth][c]{
\input{es/m4-01-ilp/forward-limit.tkz}
}\end{column}
...
\makebox[\textwidth][c]{
\input{es/m4-01-ilp/memory-stall.tkz}
}
\end{frame}

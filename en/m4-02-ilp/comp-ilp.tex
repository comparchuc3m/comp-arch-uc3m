...
\begin{itemize}
  \item ILP directly applicable to basic blocks.
    \begin{itemize}
      ...
      \item \textmark{Typical} program in MIPS:
        \begin{itemize}
...
\begin{itemize}
  \item \textgood{R1} $\rightarrow$ Last array element.
  \item \textgood{F2} $\rightarrow$ Scalar \cppid{s}.
  \item \textgood{R2} $\rightarrow$ Precomputed so that \asmlabel{8(R2)} is the first element in array.
\end{itemize}
...
\begin{itemize}
  \item Code reorganization.
    ...
    \end{itemize}
  \item Update of \asmreg{R1} at enough distance from
        \asminst{BNE}.
